...
\centering
\includegraphics[width=\textwidth]{../code/output/coverages/maps/coverage_map_oceanic.png}
...
In this study, we will be using both the Maximum Clade Credibility Tree (MCCT) and posterior trees from \citet{grayetal_2009} as well as the tree from Glottolog 
