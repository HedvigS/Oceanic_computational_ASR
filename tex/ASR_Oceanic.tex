...
\centering
\includegraphics[width=\textwidth]{../code/output/other_plots/coverage_map_oceanic.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../code/output/other_plots/Oceanic_tree_desc_status_gray_et_al_tree_mcct.png}
