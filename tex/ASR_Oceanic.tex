...
\label{acr:intro}
Linguistic history offers us a unique and insightful window into our human past. By reconstructing the paths of language change, we can infer migrations paths of people. By reconstructing the words and grammars of languages, we can learn about communities long gone. Historical linguistics is devoted to this endeavour and has made great strides in our understanding of language history since its inception. We have found many language families around the world through the Comparative Method, and reconstructed words and grammars of proto-languages with high certainty. 

In recent years, linguists have applied computational methods from biology to the reconstruction of linguistic history. Biologist have, similarly to linguists, been interested in inferring trees, previous states and the tempo and mode of evolution. <insert bit from simon about how they borrowed trees back and forth>. Examples of linguists who have borrowed from these methods are for example \citet{jager2018using} and \citet{carling2021reconstructing}. 
