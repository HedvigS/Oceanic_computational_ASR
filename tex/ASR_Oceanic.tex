...
The fundamentals of specifically ASR in traditional historical linguistics, be it concerning the reconstruction of matter (sounds or words) or patterns (structural features) relies on three principles: i) fewest amount of changes on the tree. ii) plausibility of changes and ii) plausibility of states or combinations of states (c.f. \citet{clark1973aspects)
). It is also possible to include information on the history of particular regions and cultural factors, but this is less often made explicit. As was highlighted earlier, ASR in historical linguistics is part of the overall toolbox of the Comparative Method, and as such is done simultaneously with the other two tasks. In this paper, we will be comparing specifically the ASR of historical linguistics to computational approaches to ASR.
