...
Rscript analysis_scripts_gray_mcct/3_get_gray_tree_mcct #pruning tree and changing tip names to glottocodes. removing duplicates and merges dialects
python3 3_create_glottolog_tree_bottom_up.py 
...
#	Rscript 4_ASR_parsimony_gray_posteriors.R
#	Rscript 4_ASR_parsimony_gray_posteriors_plotting.R
