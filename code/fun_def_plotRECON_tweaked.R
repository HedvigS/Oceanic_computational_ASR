#This function is a tweaked version of corHMM::plotRECON. The changes are entirely aesthic, it is now possible to remove the legend, set tip-states, modify the tip label offset and remove margins.

###################
#   plot.recons   #
###################

plotRECON_tweaked <- function(phy, 
                              likelihoods, 
                              piecolors=NULL, 
                              cex=0.5, 
                              pie.cex=0.25, 
